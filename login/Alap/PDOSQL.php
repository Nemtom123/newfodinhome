...
class PDOSQL  {
    ...
    public function __construct($SQl_Type) {
        ...
        switch( $SQl_Type ){
            case    'MySql' :   $this->kapcsolat = new PDO("mysql:host=iroda.mosaic.hu:3307;dbname=c12_polilakk;charset=utf8","felhasznalonev","jelszo");
                                break;
            case    'MsSql' :   $this->kapcsolat = new PDO("sqlsrv:server=WIN-D332LH7RHRI\SQLEXPRESS;Database=Polilakk","PolilakkSQL","1@bD38Wz9k!");
                                break;
        }
    }
