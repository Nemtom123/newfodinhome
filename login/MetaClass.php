...
class MetaClass
{
    ...
    public function MetaInsert($metaleiras, $metaleiras2, $banner, $h1, $banner2, $banner3)
    {
        try {
    ...
    public function UpdateMeta($metaleiras, $metaleiras2, $oldalneve, $banner, $h1, $banner2, $banner3)
    {
        try {
            $metaupgrade = $this->levelezes->prepare("UPDATE meta SET metaleiras= :metaleiras, metaleiras2= :metaleiras2, oldalneve= :oldalneve, banner= :banner, h1= :h1, banner2= :banner2, banner3= :banner3 WHERE oldalneve= :oldalneve");
