...
class FooterPdo
{
    ...
    public function adatbazisBeszurEn($footer_id, $egy_szakasz_egy, $egy_szakasz_ketto, $egy_szakasz_harom, $egy_szakasz_negy, $egy_szakasz_link_egy,
                                    $egy_szakasz_link_ketto, $egy_szakasz_link_harom, $ketto_szakasz_egy, $ketto_szakasz_ketto, $ketto_szakasz_harom,
                                    $ketto_szakasz_negy, $ketto_szakasz_link_egy, $ketto_szakasz_link_ketto, $ketto_szakasz_link_harom,
                                    $harom_szakasz_egy, $harom_szakasz_ketto, $harom_szakasz_harom, $harom_szakasz_negy, $harom_szakasz_link_egy, $harom_szakasz_link_ketto,
                                    $harom_szakasz_link_harom, $negy_szakasz_egy, $negy_szakasz_ketto, $negy_szakasz_harom,
                                    ...
                                    $ot_szakasz_link_egy, $ot_szakasz_link_ketto, $ot_szakasz_link_harom)
    {
        ...
        try {
            $banner = $this->kapcsolodik->prepare("INSERT INTO  footeren  (:footer_id,
                  :egy_szakasz_egy,
                  :egy_szakasz_ketto,
                  :egy_szakasz_harom,
                  :egy_szakasz_negy,
                  :egy_szakasz_link_egy,egy_szakasz_link_ketto,
                  :egy_szakasz_link_harom,
                  :ketto_szakasz_egy,ketto_szakasz_ketto,
                  :ketto_szakasz_harom,ketto_szakasz_negy,
                  :ketto_szakasz_link_egy,
                  :ketto_szakasz_link_ketto,
                  :ketto_szakasz_link_harom,
                  :harom_szakasz_egy,
                  :harom_szakasz_ketto,
                  :harom_szakasz_harom,
                  :harom_szakasz_negy,
                  :harom_szakasz_link_egy,
                  :harom_szakasz_link_ketto,
                  :harom_szakasz_link_harom,
                  :negy_szakasz_egy,
                  :negy_szakasz_ketto,
                  :negy_szakasz_harom,
                  :negy_szakasz_negy,
                  :negy_szakasz_link_egy,
                  :negy_szakasz_link_ketto,
                  :negy_szakasz_link_harom,
                  :ot_szakasz_egy,
                  :ot_szakasz_ketto,
                  :ot_szakasz_harom,
                  :ot_szakasz_negy,
