...
?>
<!-- FOOTER  MOBILE -->
<footer class="md:hidden bg-gray-900 text-white" style="color:white">
    <!-- Footer Top -->
    <div class="bg-gray-800 mx-auto px-11">
        <div class="container flex flex-col md:flex-row justify-between items-center mx-auto">
            ...
            <div class="social w-full mx-5 my-5 flex justify-center text-center" style="color:white">
                <a class="block flex items-center text-gray-300 hover:text-white mr-6 no-underline" href="#" style="color:white">
                ...
                <a class="block flex items-center text-gray-300 hover:text-white no-underline" href="#" style="color:white">
                    <svg viewBox="0 0 24 24" class="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="tab w-full overflow-hidden">
                ...
                <div class="tab-content overflow-hidden leading-normal">
                    <ul class="w-full flex flex-col text-gray-700 list-none p-0 font-thin text-left">
                        <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                        <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                        <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                        <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                    </ul>
    ...
    <div class="border-t border-gray-800 flex flex-col md:flex-row justify-center items-center p-6 mt-4 text-gray-600">
        <div>© Fodin-Home Kft</div>
        <div>&nbsp;Minden jog fentartva.<div>
            </div>
</footer>

<!-- FOOTER  DESKTOP ASZTALI -->
<footer class="hidden md:block bg-gray-900 text-white">
    <!-- Footer Top -->
    <div class="bg-gray-800 mx-auto px-11">
        <div class="container flex flex-col md:flex-row justify-between items-center mx-auto" style="height: 60px">
    ...
    <div class="container overflow-hidden flex flex-col lg:flex-row justify-between mx-auto p-4">
        <div class="container block md:flex text-sm mt-6 lg:mt-0">
            <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Generálkivitelezés</li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
            ...
            <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Családi ház</li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a>
                </li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
            </ul>
            <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Lakásfelujítás</li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                </li>
            ...
            <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Belsőépítészet</li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                </li>
            ...
            <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Átalakítás</li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                <li><a href="#" class="inline-block py-2 pl-3 pr-5 text-gray-500 hover:text-white no-underline">Szöveg</a></li>
                </li>
